...
# As a downside we end up with a swiftBuild.so, but it only adds ~1kb to the APK.
file(WRITE .empty.c "") # we need to build *something*, even if it's an empty file
add_library(swiftBuild SHARED .empty.c)
add_dependencies(swiftBuild allTarget)
...
function(build_swift_project)
    execute_process(
        COMMAND bash -c "LIBRARY_OUTPUT_DIRECTORY=${LIBRARY_OUTPUT_DIRECTORY} ANDROID_ABI=${ANDROID_ABI} CMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} ${SWIFT_TOOLCHAIN_ROOT}/swift-configure.sh ${PROJECT_DIRECTORY}"
    )
